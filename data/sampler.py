    ...
    def __iter__(self):
        ...
        for bucket in buckets:
            ...
            for indices in partition_all(self._size_mul, bucket):
                ...
                # print("1len(batch_indices)",len(batch_indices))
                # print("1max_len", max_len)
                if batch_indices and (max_len * (len(batch_indices) + self._size_mul) > self._max_tok):
                    # print("self._max_tok",self._max_tok)
                    # print("xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx")
                    # print("2max_len", max_len)
                    # print("2len(batch_indices)", len(batch_indices))
                    # print("1max_len", max_len)
