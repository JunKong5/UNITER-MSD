...
from model.vqa_msd_feature import UniterForVisualQuestionAnswering
...
def main(opts):
    ...
    LOGGER.info(f"***** Running training VQA with MSD-feature *****")
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            if (step + 1) % opts.gradient_accumulation_steps == 0:
                ...
                if global_step % opts.valid_steps == 0:
                    val_log, results = validate(model, val_dataloader, label2ans,len_val_dataset, eval_threshold =True)
...
@torch.no_grad()
def validate(model, val_loader, label2ans,len_val_dataset,eval_threshold =True):
    ...
    if eval_threshold:
        ...
        full_cost = len_val_dataset * model.num_layers
